...
exports.handler = async (event) => {
    ...
    try {
        ...
        try {
            ...
            return { statusCode: 400, headers, body: JSON.stringify({ error: 'خطأ في تحليل JSON: '  }) };
        }
        ...
        if (error) {
            ...
            return { statusCode: 500, headers, body: JSON.stringify({ error: 'خطأ في إضافة البيانات: '  }) };
        }
